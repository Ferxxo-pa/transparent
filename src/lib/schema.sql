...
CREATE TABLE IF NOT EXISTS games (
  ...
  question_mode TEXT NOT NULL DEFAULT 'classic' CHECK (question_mode IN ('classic', 'exposer', 'storyteller', 'free-for-all', 'custom', 'hot-take')),
  custom_questions JSONB, -- reserved for future use
  game_phase TEXT CHECK (game_phase IN ('host-picking', 'player-voting', 'submitting-questions', 'voting-question', 'exposer-bidding', 'picking-question', 'answering', 'voting-honesty', 'storyteller-prep', 'storyteller-telling', 'storyteller-voting', 'storyteller-reveal')),
...
-- Question submissions table (for exposer mode)
