...
const MODES: GameMode[] = [
  {
    ...
    hook: 'cap or no cap?',
    sub: 'pre-loaded prompts from the vault. you answer, the table decides if you\'re lying.',
  },
  {
    key: 'hottake',
    emoji: '🌶️',
    ...
    palette: 'story',
    title: 'they write the questions.',
    hook: 'pay to push.',
    sub: 'players write questions for the hot seat. put money behind a question to make them answer it.',
  },
  {
    key: 'story',
    emoji: '🎭',
    ...
    title: 'tell a story.',
    hook: 'real or fake?',
    sub: 'spin a story — true or completely made up. the table votes if you\'re capping.',
  },
  {
    key: 'custom',
    emoji: '🛠️',
    ...
    hook: 'your questions.',
    sub: 'every player submits questions before the game starts. your group, your rules.',
  },
];
