...
const MODES: GameMode[] = [
  {
    ...
    title: 'nobody beats',
    hook: 'this game mode.',
    sub: 'you answer a random question — truth or lie. your friends bet on whether you\'re capping. get caught? you pay.',
  },
  {
    key: 'hottake',
    emoji: '🌶️',
    ...
    palette: 'story',
    title: 'this one ruins',
    hook: 'friendships.',
    sub: 'your friends write the questions for you. they can pay to force the worst ones. you have to answer. no skipping.',
  },
  {
    key: 'story',
    emoji: '🎭',
    ...
    title: 'bet you can\'t',
    hook: 'fool everyone.',
    sub: 'tell a story — real or completely made up. if the table believes you, you win the pot. best liars eat.',
  },
  {
    key: 'custom',
    emoji: '🛠️',
    ...
    palette: 'join',
    title: 'only play this',
    hook: 'with your people.',
    sub: 'everyone adds questions before the game. inside jokes, unhinged takes, stuff only your group would know.',
  },
];
