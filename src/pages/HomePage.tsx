...
const MODES: GameMode[] = [
  {
    ...
    title: 'we ask.',
    hook: 'you answer.',
    sub: 'random questions from our deck. answer honestly or lie — the group guesses.',
  },
  {
    key: 'hottake',
    emoji: '🌶️',
    ...
    palette: 'story',
    title: 'your friends ask.',
    hook: 'you sweat.',
    sub: 'the group writes questions for you. put money on a question to force it.',
  },
  {
    key: 'story',
    emoji: '🎭',
    ...
    title: 'tell a story.',
    hook: 'truth or cap?',
    sub: 'you tell a story. it can be real or totally made up. everyone votes: truth or cap.',
  },
  {
    key: 'custom',
    emoji: '🛠️',
    ...
    title: 'you write.',
    hook: 'all of them.',
    sub: 'every player adds questions before the game. your group makes the rules.',
  },
];
