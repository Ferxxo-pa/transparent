...
const MODES: GameMode[] = [
  {
    ...
    palette: 'home',
    title: 'can you keep',
    hook: 'a straight face?',
    sub: 'you get a crazy question. lie or tell the truth — if they catch you, you lose everything.',
  },
  {
    key: 'hottake',
    emoji: '🌶️',
    ...
    palette: 'story',
    title: 'your friends pick',
    hook: 'what you answer.',
    sub: 'they write the questions. they pay to force them. you can\'t say no. good luck.',
  },
  {
    key: 'story',
    emoji: '🎭',
    ...
    title: 'biggest liar',
    hook: 'wins the pot.',
    sub: 'tell a story so wild nobody knows if it\'s real. fool the table, take the money.',
  },
  {
    key: 'custom',
    emoji: '🛠️',
    ...
    hook: 'what to ask.',
    sub: 'your group writes every question. inside jokes, wild takes, anything goes.',
  },
];
