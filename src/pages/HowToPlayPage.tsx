...
const MODES: ModeInfo[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'everyone else writes a question for them.',
      'players bid money to force the worst questions.',
      'the hot seat player MUST answer — no dodging.',
  ...
  },
  {
    ...
    steps: [
      ...
      'the table bets money on "real" or "cap".',
      'wrong guessers pay the correct voters.',
    ],
  },
  {
    id: 'free-for-all',
    ...
    steps: [
      ...
      'classic, exposer, or storyteller — anything goes.',
      'you don\'t know what\'s coming next.',
      'adapts to whatever your group is feeling.',
    ],
  },
];
